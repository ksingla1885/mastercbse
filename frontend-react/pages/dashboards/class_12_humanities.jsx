...
<head>
    ...
    <title>Class 12 Humanities Dashboard - mastercbse</title>
    ...
    <div class="container">
        <div class="header">
            <div class="header-left">
                <h1>Class 12 - Humanities Stream</h1>
                <p id="welcomeMsg">Welcome to your learning center</p>
                <div class="stream-badge">Humanities Stream</div>
            </div>
            <div class="user-info">
    ...
    <script>
        const SUBJECTS = [
            { 
                ...
                description: 'Core & Elective - Literature, Drama & Poetry'
            },
            { 
                name: 'History', 
                icon: 'fa-clock', 
                chapters: '16 Chapters',
                description: 'Modern India, World History & Source Analysis'
            },
            { 
                name: 'Geography', 
                icon: 'fa-globe', 
                chapters: '14 Chapters',
                description: 'Human & Physical Geography, Development Issues'
            },
            { 
                name: 'Political Science', 
                icon: 'fa-landmark', 
                chapters: '13 Chapters',
                description: 'Indian Politics & International Relations'
            }
        ];
