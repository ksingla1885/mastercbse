...
<head>
    ...
    <title>Class 12 PCM Dashboard - mastercbse</title>
    ...
    <div class="container">
        <div class="header">
            <div class="header-left">
                <h1>Class 12 - Physics, Chemistry & Mathematics</h1>
                <p id="welcomeMsg">Welcome to your learning center</p>
                <div class="stream-badge">Science Stream (PCM)</div>
            </div>
            <div class="user-info">
    ...
    <script>
        const SUBJECTS = [
            { 
                ...
                description: 'Electrostatics, Current, Optics, Semiconductors & more'
            },
            { 
                name: 'Chemistry', 
                icon: 'fa-atom', 
                chapters: '16 Chapters',
                description: 'Solutions, Electrochemistry, P-block, Organic Compounds'
            },
            { 
                name: 'Mathematics', 
                icon: 'fa-calculator', 
                chapters: '14 Chapters',
                description: 'Relations, Calculus, Linear Programming, 3D Geometry'
            }
        ];
