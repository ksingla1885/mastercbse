...
<head>
    ...
    <title>Class 9 Dashboard - mastercbse</title>
...
<body>
    ...
    <script>
        const SUBJECTS = [
            { name: 'Mathematics', icon: 'fa-calculator', chapters: '15 Chapters' },
            { name: 'English', icon: 'fa-book', chapters: '12 Chapters' },
            { name: 'Science', icon: 'fa-flask', chapters: '18 Chapters' },
            { name: 'Social Science', icon: 'fa-globe', chapters: '14 Chapters' },
            { name: 'Hindi', icon: 'fa-language', chapters: '10 Chapters' },
            { name: 'Computer', icon: 'fa-laptop', chapters: '8 Chapters' }
        ];
