...
<head>
    ...
    <title>Class 11 Commerce Dashboard - mastercbse</title>
    ...
    <div class="container">
        <div class="header">
            <div class="header-left">
                <h1>Class 11 - Commerce Stream</h1>
                <p id="welcomeMsg">Welcome to your learning center</p>
                <div class="stream-badge">Commerce Stream</div>
            </div>
            <div class="user-info">
    ...
    <script>
        const SUBJECTS = [
            { 
                ...
                description: 'Financial Accounting, Journal, Ledger & Financial Statements'
            },
            { 
                name: 'Business Studies', 
                icon: 'fa-briefcase', 
                chapters: '16 Chapters',
                description: 'Business Organizations, Management & Entrepreneurship'
            },
            { 
                name: 'Economics', 
                icon: 'fa-chart-line', 
                chapters: '15 Chapters',
                description: 'Microeconomics, Macroeconomics & Indian Economy'
            }
        ];
