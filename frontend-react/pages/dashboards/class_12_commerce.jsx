...
<head>
    ...
    <title>Class 12 Commerce Dashboard - mastercbse</title>
    ...
    <div class="container">
        <div class="header">
            <div class="header-left">
                <h1>Class 12 - Commerce Stream</h1>
    ...
    <script>
        const SUBJECTS = [
            { 
                ...
                description: 'Partnership, Company Accounts, Cash Flow & Analysis'
            },
            { 
                name: 'Business Studies', 
                icon: 'fa-briefcase', 
                chapters: '17 Chapters',
                description: 'Finance, Marketing, HRM & Business Ethics'
            },
            { 
                name: 'Economics', 
                icon: 'fa-chart-line', 
                chapters: '16 Chapters',
                description: 'National Income, Money & Banking, International Trade'
            }
        ];
