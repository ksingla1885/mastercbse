...
<head>
    ...
    <title>Class 11 Humanities Dashboard - mastercbse</title>
    ...
    <div class="container">
        <div class="header">
            <div class="header-left">
                <h1>Class 11 - Humanities Stream</h1>
    ...
    <script>
        const SUBJECTS = [
            { 
                ...
                description: 'Literature, Grammar, Prose & Verse'
            },
            { 
                name: 'History', 
                icon: 'fa-clock', 
            ...
            { 
                ...
                description: 'Physical & Human Geography of India'
            },
            { 
                name: 'Political Science', 
                icon: 'fa-landmark', 
                chapters: '12 Chapters',
                description: 'Indian Constitution & Political System'
            }
        ];
