...
<head>
    ...
    <title>Class 12 PCB Dashboard - mastercbse</title>
    ...
    <div class="container">
        <div class="header">
            <div class="header-left">
                <h1>Class 12 - Physics, Chemistry & Biology</h1>
    ...
    <script>
        const SUBJECTS = [
            ...
            { 
                ...
                description: 'Solutions, Electrochemistry, Coordination Compounds'
            },
            { 
                name: 'Biology', 
                icon: 'fa-dna', 
                chapters: '16 Chapters',
                description: 'Reproduction, Evolution, Ecology & Biotechnology'
            }
        ];
